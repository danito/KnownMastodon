...
if (empty($vars['render-template']))
    $vars['render-template'] = 'forms/components/usersmastodon/user';
?>
    ...
    <form action="<?php echo $vars['source-url']; ?>">
        <div class="search-controls">
            <div class="input-group">
                <input name="query" type="text" class="form-control" placeholder="<?php echo \Idno\Core\Idno::site()->language()->_('Search by name, email address, blood group, or username'); ?>" aria-describedby="search">
